...
// Dialog.Root is a context provider with no DOM element of its own, so there is
// nothing for a ref to attach to and it stays a plain function component.
...
// The ref targets the popup, not the surrounding portal/overlay: the popup is
// the dialog surface consumers measure, focus, or scroll.
