...
// Popover.Root is a context provider with no DOM element of its own, so there
// is nothing for a ref to attach to and it stays a plain function component.
...
// are layout plumbing; the popup is the element consumers focus or measure.
